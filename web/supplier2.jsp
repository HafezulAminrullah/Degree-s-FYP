<%-- 
    Document   : supplier2
    Created on : May 2, 2023, 4:59:24 PM
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">New <b>Supplier</b></h1>
                        </div>

                    </div>
     
        <form name="frmAddSupplier" action="supplierController?action=insert&supplierid=0" method="POST">
...
<div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label>Name</label>
                        <input type="text" name="supplierName" value="" size="40" class="form-control" required="" />
                    </div>
                    <div class="form-group">
                        
                        <label>Address</label>
                        <input type="text" name="supplierAddress" value="" size="40" class="form-control" required="" />
                    </div>
                    <div class="form-group">
                         
                        <label>Contact</label>
                        <input type="text" name="contact" value="" size="55" class="form-control" required="" />
                    </div>
