        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header"><b>Receipt</b></h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    <!-- /.row -->
                   ...
                   <div class="container bootdey">
                       <div class="col-md-12">
                           <div class="col-md-8">
                               <a href="orderHistory.jsp" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back</a>
                               <div class="portlet light bordered">
                                   ...
                                   <div class="portlet-body text-center">
                                       <img src="receipt.jsp?id=<%=request.getParameter("id")%>"> 
                                   </div>
                               </div>
                           </div>
                       </div>
