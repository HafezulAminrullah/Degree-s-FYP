<%-- 
    Document   : listSupplier2
    Created on : May 2, 2023, 5:04:25 PM
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Manage <b>Supplier</b></h1>
                        </div>
                        ...
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <a href="supplierController?action=insert" class="btn btn-success" data-toggle="modal"><i class="fa fa-plus-circle"></i> <span>Add New Supplier</span></a>				
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        <c:forEach items="${suppliers}" var="supplier">
                                            <tr>
                                                ...
                                                <td><a href="supplierController?action=edit&supplierId=<c:out value="${supplier.supplierid}"/>"class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a></td>
                                                <td><a href="supplierController?action=delete&supplierId=<c:out value="${supplier.supplierid}"/>"class="delete" onclick="return confirm('Are you sure you want to delete?')"  data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a></td>
                                            </tr>  
                                        </c:forEach>
                                    </tbody>
                                </table>
